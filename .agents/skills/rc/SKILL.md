...
- **Artifact-driven.** Planning and review artifacts live as markdown under `.rc/tasks/<slug>/`, versioned alongside the codebase.
...
1. **Setup** -- `rc setup` installs core skills into target agents plus any setup assets shipped by enabled extensions.
...
digraph rc_pipeline {
    "rc setup" [shape=box];
    "/rc-idea-factory (optional)" [shape=box];
    "/rc-create-prd" [shape=box];
    "/rc-create-techspec" [shape=box];
    "/rc-create-tasks" [shape=box];
    "rc tasks run" [shape=box];
    "Review (manual or provider)" [shape=box];
    "rc reviews fix" [shape=box];
    "Reviews clean?" [shape=diamond];
    "rc archive" [shape=doublecircle];

    "rc setup" -> "/rc-idea-factory (optional)";
    "/rc-idea-factory (optional)" -> "/rc-create-prd";
    "/rc-create-prd" -> "/rc-create-techspec";
    "/rc-create-techspec" -> "/rc-create-tasks";
    "/rc-create-tasks" -> "rc tasks run";
    "rc tasks run" -> "Review (manual or provider)";
    "Review (manual or provider)" -> "rc reviews fix";
    "rc reviews fix" -> "Reviews clean?";
    "Reviews clean?" -> "Review (manual or provider)" [label="no"];
    "Reviews clean?" -> "rc archive" [label="yes"];
}
```
