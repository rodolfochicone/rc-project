...
2. Execute `eval "$(python3 .agents/skills/smux-rc-pairing/scripts/render-session-plan.py --feature-name "<feature-name>" --repo-root "$PWD")"` to load the emitted shell assignments into the current shell.
