...
6. Learn: run the `rc-memory` skill to distill recurring corrections and patterns from this session into `.rc/memory/LEARNINGS.md` (no-op when nothing durable is worth capturing).
