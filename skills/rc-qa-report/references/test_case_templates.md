...
- **Automation Notes:** record the rationale, blocker, or handoff expectation for `rc-qa-execution`
...
Standard viewports shared with `rc-qa-execution`:
...
| Missing | Harness exists but coverage does not | `rc-qa-execution` should add or update it |
