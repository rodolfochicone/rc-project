...
### Question Limits
- Ask at most 3 questions total across the whole protocol. The phase prompts above are an illustrative menu, not a checklist — pick the 3 that matter most for this feature.
