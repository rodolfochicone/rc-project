...
See [references/best-practices.md](./references/best-practices.md) for practical guidelines on:
...
For detailed configuration and patterns, see [references/best-practices.md](./references/best-practices.md).
...
For detailed patterns, see [references/best-practices.md](./references/best-practices.md#type-testing-patterns).
...
For detailed examples, see [references/best-practices.md](./references/best-practices.md#performance-considerations).
