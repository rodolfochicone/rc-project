...
- **Agent dispatch is unavailable or the council archetypes are missing**: stop and tell the user to install or update the rc plugin — the archetypes ship in its `agents/` directory.
