...
description: >-
  ...
  distinct critical lenses. Triggers: "adversarial review". Do not use for same-model
  review (use rc-code-review), a routine single-pass review, or automated remediation
  (use rc-fix-reviews).
