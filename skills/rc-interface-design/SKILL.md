...
**Not for:** Landing pages, marketing sites, campaigns. Redirect those to `/rc-frontend-design`.
...
- `/rc-interface-design:status` — Current system state
- `/rc-interface-design:audit` — Check code against system
- `/rc-interface-design:extract` — Extract patterns from code
- `/rc-interface-design:critique` — Critique your build for craft, then rebuild what defaulted
